...
public class SecurityManagedBean
{
    ...
    private final String DEFAULT_DOMAIN_CONFIG_DIRECTORY = System.getProperty("D:\\2014_2015\\IS3102\\Softwares\\glassfish-4.0\\glassfish\\domains\\domain1\\config");
    ...
    private static SecurityManagedBean securityManagedBean = null;



    public SecurityManagedBean()
    {
        doInitializeSecurityManagedBean();
    }

    
    
    public static SecurityManagedBean getInstanceOf()
    {
        if (securityManagedBean == null)
        {
            securityManagedBean = new SecurityManagedBean();
        }

        return securityManagedBean;
    }

    
    
    private void doInitializeSecurityManagedBean()
    {
        try
        {
