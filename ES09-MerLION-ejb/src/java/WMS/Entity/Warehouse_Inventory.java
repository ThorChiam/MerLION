 ...
 */
@Entity
public class Warehouse_Inventory implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Warehouse_Inventory)) {
            return false;
        }
        Warehouse_Inventory other = (Warehouse_Inventory) object;
    ...
    public String toString() {
        return "WMS.Entity.Warehouse_Inventory[ id=" + id + " ]";
    }
